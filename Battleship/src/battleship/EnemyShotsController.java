...
public class EnemyShotsController {
    ...
    public void initialize ()
	{
		...
		//Create reference to player's Board in which the Enemy shots 
		Board plBoard;
		plBoard = SampleController.playerBoard;
		...
		if (plBoard.total_shots>=5)
		{
			
			
			// Line 1 
			int x1     = plBoard.shots_info[0][plBoard.total_shots-5];
			int y1     = plBoard.shots_info[1][plBoard.total_shots-5];
			int res1   = plBoard.shots_info[2][plBoard.total_shots-5];
			int ship_1 = plBoard.shots_info[3][plBoard.total_shots-5];
			...
			// Line 2 
			int x2     = plBoard.shots_info[0][plBoard.total_shots-4];
			int y2     = plBoard.shots_info[1][plBoard.total_shots-4];
			int res2   = plBoard.shots_info[2][plBoard.total_shots-4];
			int ship_2 = plBoard.shots_info[3][plBoard.total_shots-4];
			...
			// Line 3
			int x3     = plBoard.shots_info[0][plBoard.total_shots-3];
			int y3     = plBoard.shots_info[1][plBoard.total_shots-3];
			int res3   = plBoard.shots_info[2][plBoard.total_shots-3];
			int ship_3 = plBoard.shots_info[3][plBoard.total_shots-3];
			...
			// Line 4 
			int x4 = plBoard.shots_info[0][plBoard.total_shots-2] ;
			int y4 = plBoard.shots_info[1][plBoard.total_shots-2];
			int res4 = plBoard.shots_info[2][plBoard.total_shots-2] ;
			int ship_4 = plBoard.shots_info[3][plBoard.total_shots-2];
			...
			// Line 5
			int x5     = plBoard.shots_info[0][plBoard.total_shots-1];
			int y5     = plBoard.shots_info[1][plBoard.total_shots-1];
			int res5   = plBoard.shots_info[2][plBoard.total_shots-1];
			int ship_5 = plBoard.shots_info[3][plBoard.total_shots-1];
